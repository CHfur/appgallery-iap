...
class ServerNotification
{
    ...
    /**
     * TODO implement pending purchase notification
     * @param  $data  - JSON decoded request body from AppGallery notification server
    ...
    public static function parse($data, string $publicKey): self
    {
        ...
        $statusUpdateNotification = $data->statusUpdateNotification;
        $notification->subscriptionResponse = new SubscriptionResponse(['inappPurchaseData' => $statusUpdateNotification->latestReceiptInfo]);
        $notification->environment = $statusUpdateNotification->environment;
